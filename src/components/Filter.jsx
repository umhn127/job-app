...
import { setLoading, setError, setJobs } from "../app/slices/jobSlices";
...
const Filter = () => {
  ...
  //* DEBOUNCE
  // Her tuş vuruşunda filtreleme yapmak düşük donanımlı cihazlarda kasmalara sebep olur api isteği atılıyorsa sunucuda gereksiz trafiğe sebep olur bu yüzüden kullanıcnın bir butona basmasını gerekitmeyen inputlarda debounce yöntemi kullanırak her tuş vuruşunda değil kullanıcı yazma işini bıraktığı anda ilgili fonksiyonu çalıştırırız. Ardışık olarak gerçekeleşen fonksiyon çağırma işlemlerinde fonksiyonu çağrıldığını görmezden gelir ancak belirli bir zaman aşımı olduğunda fonksiyonu çalıştırır
  useEffect(() => {
